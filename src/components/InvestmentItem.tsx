    ...
    >
      ...
      <div className="flex items-center justify-between gap-3 pb-3 border-b border-[#18294a]">
        ...
        <div className="shrink-0">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black uppercase bg-[#142343] text-amber-300 border border-[#1e3663] shadow-xs">
